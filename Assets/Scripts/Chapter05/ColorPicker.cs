...
public class ColorPicker : MonoBehaviour {
	...
	void OnGUI() {
        GUI.Box(new Rect(0, 0, 120, 240), "Color Picker");
        ...
        GUI.Label(new Rect(10, 200, 100, 20), "PixelPosX: " + Mathf.FloorToInt(m_pixelPosition.x));
        GUI.Label(new Rect(10, 220, 100, 20), "PixelPosY: " + Mathf.FloorToInt(m_pixelPosition.y));
    }
}
